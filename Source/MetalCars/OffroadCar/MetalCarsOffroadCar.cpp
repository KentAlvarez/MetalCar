...
#include "MetalCarsOffroadCar.h"
#include "MetalCarsOffroadWheelFront.h"
#include "MetalCarsOffroadWheelRear.h"
...
AMetalCarsOffroadCar::AMetalCarsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMetalCarsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMetalCarsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMetalCarsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMetalCarsOffroadWheelRear::StaticClass();
