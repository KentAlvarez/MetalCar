...
#include "MetalCarsSportsCar.h"
#include "MetalCarsSportsWheelFront.h"
#include "MetalCarsSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AMetalCarsSportsCar::AMetalCarsSportsCar()
{
	// Nota: para iterar mas rapido, la configuracion del vehiculo puede ajustarse en el Blueprint
	...
	// Configura el motor
	// NOTA: revisar el asset Blueprint para la curva de torque
